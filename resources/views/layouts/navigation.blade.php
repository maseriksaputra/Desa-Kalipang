<nav x-data="{ open: false }" class="relative z-50 bg-white dark:bg-slate-800/80 dark:backdrop-blur-xl border-b border-gray-100 dark:border-slate-700/50 transition-all duration-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-lg text-sm p-2.5 mr-2 transition-colors">
